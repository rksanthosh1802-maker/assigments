...
/**
 * MainActivity - hosts the GLSurfaceView and forwards its lifecycle
 * callbacks to the native Renderer via JNI. No touch interaction is
 * required for this assignment; rendering runs continuously.
 */
public class MainActivity extends AppCompatActivity {

    private static final String TAG = "AndroidProgrammingQuiz";
