@echo off
REM =============================================================================
REM script_build_and_run.bat - Desktop build and run for the 3D Fan
REM
REM Prerequisites:
REM   - CMake 3.15+ in PATH
REM   - Visual Studio 2022 (or adjust the generator below)
REM   - Internet access (CMake downloads GLFW, GLEW and GLM via FetchContent)
REM
...
echo [3/3] Running ...
echo.
echo Controls: Click a HUD button (+SPD/-SPD/+ZOOM/-ZOOM), or click the fan
echo to pick a part. ESC = quit
echo.
